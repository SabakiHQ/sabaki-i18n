module.exports = {
    'menu.file': {
      ...
      'Load SGF': 'SGF öffnen',
      'Copy SGF': 'SGF kopieren',
      'Copy ASCII Diagram': 'ASCII Diagramm kopieren',
      'Game Info': 'Spielinformationen',
      'Manage Games…': 'Spiele verwalten…',
    ...
    'exception': {
      ...
      'Something weird happened. ${appName} will shut itself down. If possible, please report this on ${appName}’s repository on GitHub.': p =>
        [
          `Ein Fehler ist aufgetreten. ${p.appName} wird beendet.`,
          `Wenn möglich, melde bitte den Vorfall bitte auf ${p.appName}’s GitHub Repository.`
        ].join(' ')
    },
    'menu.play': {
      'Play': 'Spielen',
      'Toggle Player': 'Spielerfarben tauschen',
      'Select Point': 'Punkt auswählen',
      'Enter a coordinate to select a point': 'Koordinaten eingeben, um einen Punkt auszuwählen',
      'Pass': 'Passen',
      'Resign': 'Aufgeben',
      'Estimate': 'Schätzen',
      'Score': 'Spielstand'
    ...
    'menu.edit': {
      ...
      'Cross Tool': 'Kreuzwerkzeug',
      'Triangle Tool': 'Dreieckswerkzeug',
      'Square Tool': 'Quadratswerkzeug',
      'Circle Tool': 'Kreiswerkzeug',
      'Line Tool': 'Linienwerkzeug',
      'Arrow Tool': 'Pfeilwerkzeug',
      'Label Tool': 'Textwerkzeug',
      'Number Tool': 'Nummernwerkzeug',
      'Copy Variation': 'Variation kopieren',
      'Cut Variation': 'Variation ausschneiden',
      'Paste Variation': 'Variation ausschneiden',
      'Make Main Variation': 'Hauptvariation erschaffen',
      'Shift Left': 'Umschalt-Links',
      'Shift Right': 'Umschalt-Rechts',
      'Flatten': 'Abflachen',
      'Remove Node': 'Knotenpunkt entfernen',
      'Remove Other Variations': 'Andere Variationen entfernen'
    },
    'menu.find': {
      'Find': null,
