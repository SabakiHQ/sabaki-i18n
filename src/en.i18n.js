module.exports = {
  ...
  "menu.play": {
    ...
    "Enter a coordinate to select a point": "Enter a coordinate to select a point",
    "Pass": "&Pass",
    "Resign": "Resig&n",
    "Estimate": "&Estimate",
    "Score": "Sco&re"
  ...
  "menu.engines": {
    ...
    "Please assign an engine to the player first.": "Please assign an engine to the player first.",
  ...
  "menu.developer": {
    ...
    "A language file is basically a JavaScript file and can be used to execute arbitrary code on your computer.\n\nIt can be extremely dangerous, so it is recommended to only load language files from authors you trust.": "A language file is basically a JavaScript file and can be used to execute arbitrary code on your computer.\n\nIt can be extremely dangerous, so it is recommended to only load language files from authors you trust.",
  ...
  "EngineSyncer": {
    "GTP engines don’t support invalid board positions.": "GTP engines don’t support invalid board positions.",
    ...
    "Current board arrangement can’t be recreated on the GTP engine.": "Current board arrangement can’t be recreated on the GTP engine.",
    "GTP engine can’t be synced to current state.": "GTP engine can’t be synced to current state."
  },
  "gtplogger": {
    "You have an invalid log folder for GTP console logging in your settings.\n\nPlease make sure the log directory is valid and writable, or disable GTP console logging.": "You have an invalid log folder for GTP console logging in your settings.\n\nPlease make sure the log directory is valid and writable, or disable GTP console logging."
  },
  "sabaki.window": {
  ...
  "sabaki.file": {
    ...
    "Your changes will be lost if you close this file without saving.": "Your changes will be lost if you close this file without saving.",
    "Save": "Save",
  ...
  "sabaki.play": {
    ...
    "You are about to play a move which repeats a previous board position.\nThis is invalid in some rulesets.": "You are about to play a move which repeats a previous board position.\nThis is invalid in some rulesets.",
    "Play Anyway": "Play Anyway",
    "Don’t Play": "Don’t Play",
    "You are about to play a suicide move.\nThis is invalid in some rulesets.": "You are about to play a suicide move.\nThis is invalid in some rulesets."
  },
  "sabaki.engine": {
    ...
    "Please attach one or more engines first.": "Please attach one or more engines first.",
    "The selected engine does not support analysis.": "The selected engine does not support analysis."
  },
  "sabaki.node": {
    "Do you really want to remove this node?": "Do you really want to remove this node?",
    "Remove Node": "Remove Node",
    "Cancel": "Cancel",
    "Do you really want to remove all other variations?": "Do you really want to remove all other variations?",
  ...
  "menu.variation": {
    ...
    "The root node cannot have sibling nodes.": "The root node cannot have sibling nodes."
  },
  "menu.engineAction": {
    "Start": "&Start",
    "Stop": "&Stop",
  ...
  "GuessBar": {
    "Click on the board to guess the next move.": "Click on the board to guess the next move."
  },
  "PlayBar": {
    "Pass": "&Pass",
    "Resign": "&Resign",
  ...
  "GameChooserDrawer": {
    ...
    "Do you really want to remove this game permanently?": "Do you really want to remove this game permanently?",
    "Cancel": "Cancel",
    "Remove Other Games": "Remove &Other Games",
    "Do you really want to remove all other games permanently?": "Do you really want to remove all other games permanently?",
  ...
  "PreferencesDrawer": {
    "Enable hardware acceleration if possible": "Enable hardware acceleration if possible",
    ...
    "Show remove other variations warning": "Show remove other variations warning",
    "Offer to reload file if changed externally": "Offer to reload file if changed externally",
    ...
    "Do you really want to uninstall this theme?": "Do you really want to uninstall this theme?",
    "Uninstall": "Uninstall",
    "Cancel": "Cancel",
